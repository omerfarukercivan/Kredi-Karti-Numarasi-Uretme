...
namespace Kredi_Kartı
{
    class VisaCardFactory:CardFactory
    {
        ...
        // Constructor
        public VisaCardFactory(int creditLimit, int point,int cvv, string cardNumber, string Date, string name_surname)
        {
        ...
        {
            return new VisaCard(_creditLimit, _point,_cvv, _CardNumber, _date, _name);
        }
    }
}
